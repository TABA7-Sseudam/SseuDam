        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="flex flex-col gap-6">
            {currentUser && (
              ...
              <Card className="p-1 h-[350px] flex justify-center items-center">
                <img src="/Ranking/pyramid1.jpg" alt="Ranking Pyramid" className="w-full h-full object-cover rounded-lg" />
              </Card>
          </div>
        </div>
      )}
