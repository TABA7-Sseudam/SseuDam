    ...
    <div className="container mx-auto p-6 bg-white">
      ...
      <Card className="p-6 shadow-md mb-6">
        ...
        <p className="text-gray-700 mb-4">
         <strong>Eco XP</strong>🌳는 분리수거 및 친환경 활동을 통해 획득하는 포인트입니다.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          ...
          <Card className="p-6 shadow-md mb-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-2">환경 보호에 무관심하며, 쓰레기를 아무렇게나 버리는 수준입니다.</p>
              <p className="text-red-600 font-bold">⚠️ 이대로면 지구가 위험합니다! 지금 당장 분리배출을 시작하세요!</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-2">분리배출을 시도하지만 실수가 많은 단계입니다.</p>
              <p className="text-green-600 font-bold">🚀 처음 분리수거를 시작하면 배정 받는 등급입니다.</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-2">올바른 분리배출을 대부분 실천하지만 가끔 실수하는 단계입니다.</p>
              <p className="text-green-500 font-bold">🌱 환경 보호에 대한 꾸준한 관심을 보여주는 등급입니다.</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 mb-2">올바른 분리배출의 모범 시민으로, 환경 보호에 앞장서는 단계입니다.</p>
              <p className="text-blue-500 font-bold">🛡 지속적인 실천으로 지구를 지키는 핵심 역할을 합니다.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 mb-2">환경 보호의 전설적인 존재로, 다른 사람을 돕는 리더 역할을 합니다.</p>
              <p className="text-yellow-500 font-bold">🏅 최고 수준의 환경 보호 실천자에게 주어지는 등급입니다.</p>
            </div>
          </Card>
