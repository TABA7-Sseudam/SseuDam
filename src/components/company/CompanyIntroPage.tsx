    ...
    <div className="min-h-screen bg-gray-50 overflow-hidden relative">
      ...
      >
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center text-center text-white">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1, duration: 1 }}>
            <Button
              onClick={() => navigate("/auth")} // '/auth'로 변경
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-12 lg:px-32">
          ...
          >
            OO 는 당신과 함께 지속 가능한 미래를 만듭니다.  {/* TODO: 회사 이름으로 변경 */}
          </motion.h1>
          ...
          >
            OO는 단순한 분리수거 앱이 아닙니다.<br /> {/* TODO: 회사 이름으로 변경 */}
          ...
          <motion.button
            ...
            onClick={() => navigate("/brand-story")}  // '/brand-story' 페이지 필요
          >
            브랜드 스토리 보기
          </motion.button>
        </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          ...
          <motion.button
            ...
            onClick={() => navigate("/services")}  // '/services' 페이지 필요
          >
            서비스 더 알아보기
          </motion.button>
        </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-12 lg:px-32">
          ...
          <motion.button
            ...
            onClick={() => navigate("/auth")} // '/contact'  -> '/auth'
          >
            지금 참여하기
          </motion.button>
        </div>
