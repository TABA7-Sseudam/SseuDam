  ...
  describe('Firestore Security Rules', () => {
    ...
    describe('Rank Accounts', () => {
      it('should allow public reading of rank accounts', async () => {
        ...
        const snapshot = await getDoc(doc(publicUser.firestore(), 'users/james/rank_accounts/rank1'));
        expect(snapshot.exists()).toBeTruthy();
      });
    ...
    describe('Analysis Result Data', () => {
      it('should allow users to read their own analysis results', async () => {
        ...
        await setDoc(
          doc(admin.firestore(), `users/${userId}/AnalyisResult_data/result1`),
          {
            score: 85,
        ...
        const resultDoc = doc(user.firestore(), `users/${userId}/AnalyisResult_data/result1`);
